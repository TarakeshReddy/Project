...
mydb = mysql.connector.connect(host = 'localhost',user = 'root',password='Tarak@2002')
...
mydb = mysql.connector.connect(host = 'localhost',user = 'root',password='Tarak@2002',database = 'INVENTORY_MANAGEMENT')
cur=mydb.cursor()
create_ = 'create table GOODS(id INTEGER(10),product_name varchar(40),color varchar(40),quantity INTEGER(10),manufacturing_date date)'
cur.execute(create_)
print("Table created succesfully")
...
mydb = mysql.connector.connect(host = 'localhost',user = 'root',password='Tarak@2002',database = 'INVENTORY_MANAGEMENT')
cur = mydb.cursor()
create_ = 'create table PURCHASE(id INTEGER(10),store_name TEXT,product_name varchar(10),color VARCHAR(20),quantity INTEGER(10),purchase_amount INTEGER(20),purchase_date DATE)'
cur.execute(create_)
print("Table created succesfully")
...
mydb = mysql.connector.connect(host = 'localhost',user = 'root',password='Tarak@2002',database = 'INVENTORY_MANAGEMENT')
cur=mydb.cursor()
create_ = 'create table SALE(id INTEGER(10),store_name VARCHAR(40),product_name VARCHAR(40),color VARCHAR(10),no_of_items INTEGER(10),sale_amount REAL,sale_date DATE,profit_margin real)'
cur.execute(create_)
print("Table created succesfully")
...
mydb = mysql.connector.connect(host = 'localhost',user = 'root',password='Tarak@2002',database = 'INVENTORY_MANAGEMENT')
cur=mydb.cursor()
insert_ = 'insert into MANUFACTURE(id,product_name,color,quantity,manufacturing_date,defective_ITEM,company_name) values(%s,%s,%s,%s,%s,%s,%s)'
values_ = [(1, 'Toy Car', 'Red', 100, '01-05-23', 0,'RR export'),(2, 'Toy Train', 'Green', 50, '01-05-23', 0,'SS Export'),(3, 'Wooden Chair', 'Brown', 200, '01-04-23', 0,'SS Export'),(4, 'Wooden Table', 'Brown', 100, '01-03-23', 0,'RR Export'),(5,'Shirt','Blue',10,'01-05-23',1,SS Export]
cur.executemany(insert_,vaues_)
mydb.commit()
...
mydb = mysql.connector.connect(host = 'localhost',user = 'root',password='Tarak@2002',database = 'INVENTORY_MANAGEMENT')
cur=mydb.cursor()
insert_ = 'insert into GOODS(id,product_name,color,quantity,manufacturing_date) values(%s,%s,%s,%s,%s)'
values_ = [(1, 'Toy Car', 'Red', 100, '01-05-23'),(2, 'Toy Ship', 'Green', 50, '01-05-23'),(3, 'Wooden Chair', 'Brown', 200, '01-04-23'),(4, 'Wooden Table', 'Brown', 100, '01-03-23'),(5,'Shirt','Blue',10,'01-05-23')]
cur.executemany(insert_,values_)
mydb.commit()
print("Data inserted succesfully")
...
mydb = mysql.connector.connect(host = 'localhost',user = 'root',password='Tarak@2002',database = 'INVENTORY_MANAGEMENT')
cur=mydb.cursor()
insert_ = 'insert into PURCHASE(id,store_name,product_name,color,quantity,purchase_amount,purchase_date) values(%s,%s,%s,%s,%s,%s,%s)'
values_ = [(1, 'MyKids', 'Toy Car', 'Red', 50, 500, '01-05-23'),(2, 'MyKids', 'Toy Ship', 'Green', 25, 250, '01-05-23'),(3, 'ORay', 'Shirt', 'Blue',10,200,'01-05-23')]
cur.executemany(insert_,values_)
mydb.commit()
print("Data inserted succesfully")
...
mydb = mysql.connector.connect(host = 'localhost',user = 'root',password='Tarak@2002',database = 'INVENTORY_MANAGEMENT')
cur=mydb.cursor()
insert_ = 'insert into SALE(id,store_name,product_name,color,no_of_items,sale_amount,sale_date,profit_margin) values(%s,%s,%s,%s,%s,%s,%s,%s)'
values_ = [(1, 'Offline', 'Toy Car', 'Green', 100, 800, '2023-04-05',10),
